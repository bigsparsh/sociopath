  ...
  return (
    <>
      ...
      <div
        ...
        style={{ backgroundImage: "url(//picsum.photos/id/294/1920/1080)" }}
      >
        <div className="hero-content flex-col gap-10 lg:flex-row-reverse">
          <div className="text-center lg:text-left">
            ...
            <p className="py-6">
              {" "}
              Socialilac represents a clean and refined interface to interact
              with your loved ones, presenting various important features that
            ...
            <form className="card-body" onSubmit={login}>
              ...
              <div className="flex justify-between items-center">
                ...
                <label className="label">
                  <div
                    className="tooltip"
                    data-tip="Enabling this will add a timer when you login and when the time runs out you will be logged out."
                  >
      ...
      <div className="p-10 grid place-items-center">
        <div className="card lg:card-side bg-base-100 shadow-xl w-fit">
          ...
          <div className="card-body">
            ...
            <p>
              Click the button to Sign up now and explore the world of
              Socialilac
            </p>
