...
const SignUp = () => {
  ...
  const sign = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const file =
      (profile_image.current as HTMLInputElement).files || "NO IMAGE";
  ...
  return (
    <div className="h-full my-3 lg:my-10 grid place-items-center">
        ...
        >
          ...
          <div className="form-control">
            ...
            <input
              ...
              ref={profile_image}
              accept="image/*"
              className="file-input-sm placeholder:text-xs bg-base-100/50 backdrop-blur-sm file-input file-input-bordered w-full max-w-xs"
            />
          </div>
          <div className="form-control">
            <label className="label">
